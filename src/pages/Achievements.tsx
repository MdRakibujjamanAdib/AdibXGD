  ...
  return (
    <PageTransition>
      <SEO
        ...
        description="Explore the awards and research publications of Md Rakibujjaman Adib."
      />
      <div className="bg-white text-black dark:bg-black dark:text-white min-h-screen pt-32 pb-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16 text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">Awards and recognition.</p>
          </div>
