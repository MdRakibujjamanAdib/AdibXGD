...
import { awards, research, certifications } from '../data/content';
  ...
  return (
    <PageTransition>
      <SEO
        ...
        description="Explore the awards, certifications, and research publications of Md Rakibujjaman Adib."
      />
